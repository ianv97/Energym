...
$contenido.='<h1 style="text-align:center;text-decoration:underline;">Informe de Asistencia de Clientes</h1>';
$contenido.='<h1 style="text-align:center;margin-bottom:5vh;">'.DateTime::createFromFormat('Y-m-d', $_POST['asistenciapdf-finicio'])->format('d/m/Y').'   A   '.DateTime::createFromFormat('Y-m-d', $_POST['asistenciapdf-ffin'])->format('d/m/Y').'</h1>';
$contenido.='</header>';
$tabla=explode("!",$_POST["asistenciapdf-tabla"]);
$tamaño=count($tabla);
$i=0;
...
$pdf->SetTitle('Energym-Asistencia de clientes');
...
$pdf->output('Energym-Asistencia de clientes.pdf', 'I');
?>