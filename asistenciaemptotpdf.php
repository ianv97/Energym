...
$contenido.='<h1 style="text-align:center;text-decoration:underline;">Informe de Asistencias Totales de Empleados</h1>';
$contenido.='<h1 style="text-align:center;margin-bottom:5vh;">'.DateTime::createFromFormat('Y-m-d', $_POST['asistenciaemptotpdf-finicio'])->format('d/m/Y').'   A   '.DateTime::createFromFormat('Y-m-d', $_POST['asistenciaemptotpdf-ffin'])->format('d/m/Y').'</h1>';
$contenido.='<h1></h1>';
$contenido.='</header>';
$contenido.='<table cellspacing="0" cellpadding="1" border="1" style="text-align:center;">';
	...
	$contenido.='</tr>';
$tabla=explode("!",$_POST["asistenciaemptotpdf-tabla"]);
$tamaño=count($tabla);
...
$pdf->SetTitle('Energym-Asistencias totales de empleados');
...
$pdf->output('Energym-Asistencias totales de empleados.pdf', 'I');
?>