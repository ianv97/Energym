	...
	<aside class="container-fluid sidebar-sticky text-white position-absolute bg-primary col-3 col-xl-2 px-1 px-sm-1 px-md-2 px-lg-4 px-xl-4 lateral">
		<form method="post" action="logout.php">
			<ul class="nav flex-column">
				...
				<li class="nav-item">
					<a href="rutinas.php" style="text-decoration:none;"><button type="button" class="subotones1 btn btn-warning btn-block my-0 my-md-2 my-lg-3 mx-1 mt-1 mb-0 px-0 px-sm-1 px-md-2 px-lg-2 px-xl-3">Rutinas</button></a>
				</li>
			    <li class="nav-item">
